...
/**
 * Created by dreamfighter on 6/26/16.
 */
public class PasswordHasher {
    ...
    /**
     * Constructor for the PasswordHasher object
     */
     ...
     */
    protected PasswordHasher(PasswordHasher t) {
    ...
    public static String digest(String input) {
        PasswordHasher digester = new PasswordHasher();
        byte[] output = new byte[digester.getDigestSize()];
        digester.update(input.getBytes(), 0, input.getBytes().length);
    ...
    /**
     * Gets the DigestSize attribute of the PasswordHasher object
     *
     * @return The DigestSize value
     */
